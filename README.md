...
3. Features
- User Authentication
a. Registration, Login & Logout system
b. Separate roles for Admin and User
...
b. Display charts (Monthly Cafe Sales)

- Other Features
a. Responsive UI
b. Clean navigation bar for both admin & user
c. Organized folder structure
